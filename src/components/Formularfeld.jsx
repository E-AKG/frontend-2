export default function Formularfeld({
  ...
  const inputClasses = `w-full px-4 py-3 border-2 rounded-xl text-[15px] transition-all duration-200
    ${error
      ? "border-red-300 bg-red-50 focus:border-red-500 focus:ring-red-200"
      : "border-gray-200 bg-white focus:border-primary-500 focus:ring-primary-200 hover:border-gray-300"
    }
